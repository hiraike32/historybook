...
"[project]/node_modules/animejs/lib/anime.esm.js [client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
 ...
 */ const getOriginalAnimatableValue = (target, propName, tweenType, animationInlineStyles)=>{
    ...
    return type === tweenTypes.OBJECT ? target[propName] || 0 : type === tweenTypes.ATTRIBUTE ? /** @type {DOMTarget} */ target.getAttribute(propName) : type === tweenTypes.TRANSFORM ? parseInlineTransforms(target, propName, animationInlineStyles) : type === tweenTypes.CSS_VAR ? getCSSValue(target, propName, animationInlineStyles).trimStart() : getCSSValue(target, propName, animationInlineStyles);
};
/**
 * @param  {Number} x
 * @param  {Number} y
 ...
 */ const parseEaseString = (string, easesFunctions, easesLookups)=>{
    ...
    if (string.indexOf('(') <= -1) {
        ...
        const parsedFn = hasParams ? /** @type {EasesFactory} */ easesFunctions[string]() : easesFunctions[string];
 ...
 */ const eases = /*#__PURE__*/ (()=>{
    ...
    for(let type in easeTypes){
        for(let name in easeInFunctions){
            ...
            list[type + name] = name === emptyString || name === 'Back' || name === 'Elastic' ? (a, b)=>easeType(/** @type {EasesFactory} */ easeIn(a, b)) : easeType(easeIn);
        }
    }
    return list;
})();
 ...
 * @param  {EasingParam} ease
 * @return {EasingFunction}
 */ const parseEasings = (ease)=>isFnc(ease) ? ease : isStr(ease) ? parseEaseString(ease, eases, JSEasesLookups) : none;
 ...
 */ const sanitizePropertyName = (propertyName, target, tweenType)=>{
    ...
    } else if (tweenType === tweenTypes.CSS || tweenType === tweenTypes.ATTRIBUTE && isSvg(target) && propertyName in /** @type {DOMTarget} */ target.style) {
 ...
 */ constructor(targets, params){
        ...
        parsedTargets.forEach(($el, i)=>{
            ...
            /** @type {CompositeOperation} */ const composite = setValue(params.composition, 'replace');
            for(let name in params){
                ...
                if (isObj(propertyValue)) {
                    ...
                    /** @type {CompositeOperation} */ tweenParams.composite = setValue(tweenOptions.composition, composite);
                    ...
                    parsedPropertyValue = isArr(propertyValue) ? propertyValue.map((/** @type {any} */ v)=>normalizeTweenValue(name, v, $el, i, targetsLength)) : normalizeTweenValue(name, propertyValue, $el, i, targetsLength);
                    if (individualTransformProperty) {
                        keyframes["--".concat(individualTransformProperty)] = parsedPropertyValue;
                        cachedTransforms[individualTransformProperty] = parsedPropertyValue;
                    } else {
 ...
 */ const remove = (targets, renderable, propertyName)=>{
    ...
    const waapiAnimation = renderable && /** @type {WAAPIAnimation} */ renderable.controlAnimation && renderable;
...
class Draggable {
   ...
   */ handleDown(e) {
        ...
        const z = getTargetValue(this.$target, 'zIndex', false);
   ...
   */ constructor(target, parameters = {}){
        ...
        const hasSpring = !isUnd(ease) && !isUnd(/** @type {Spring} */ ease.ease);
        const xProp = isObj(paramX) && !isUnd(/** @type {Object} */ paramX.mapTo) ? /** @type {Object} */ paramX.mapTo : 'translateX';
        const yProp = isObj(paramY) && !isUnd(/** @type {Object} */ paramY.mapTo) ? /** @type {Object} */ paramY.mapTo : 'translateY';
        ...
        /** @type {Spring} */ this.releaseXSpring = hasSpring ? ease : createSpring({
            mass: setValue(parameters.releaseMass, 1),
            stiffness: setValue(parameters.releaseStiffness, 80),
            damping: setValue(parameters.releaseDamping, 20)
        });
        /** @type {Spring} */ this.releaseYSpring = hasSpring ? ease : createSpring({
            mass: setValue(parameters.releaseMass, 1),
            stiffness: setValue(parameters.releaseStiffness, 80),
            damping: setValue(parameters.releaseDamping, 20)
        });
        ...
        /** @type {AnimatableObject} */ this.animate = new Animatable(this.$target, animatableParams);
        // Internal props
        this.xProp = xProp;
        this.yProp = yProp;
        this.destX = 0;
 ...
 */ class Scope {
   ...
   */ handleEvent(e) {
    ...
    /** @param {ScopeParams} [parameters] */ constructor(parameters = {}){
        ...
        if (rootParam) {
            root = /** @type {ReactRef} */ rootParam.current || /** @type {AngularRef} */ rootParam.nativeElement || parseTargets(rootParam)[0] || doc;
        }
        ...
        if (linked) {
            ...
            if (!this._params.target) {
                ...
                if (!isUnd(/** @type {JSAnimation} */ linked.targets)) {
                    ...
                    forEachChildren(linked, (/** @type {JSAnimation} */ child)=>{
...
//# sourceMappingURL=node_modules_animejs_lib_anime_esm_1c9bba26.js.map