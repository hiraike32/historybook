...
react_dom_1.default.render(react_1.default.createElement(react_redux_1.Provider, { store: store_1.default },
    react_1.default.createElement("h1", null, "Hello World!")), document.getElementById("app"));
...
const state_1 = __importDefault(__webpack_require__(/*! ../state */ "./src/state/index.ts"));
const store = redux_1.createStore(state_1.default, redux_devtools_extension_1.composeWithDevTools(redux_1.applyMiddleware()));
